    ...
    <asp:Panel CssClass="add_entry" ID="pnlEntryDetails" runat="server" DefaultButton="btnAddEntry" Visible="false">
        ...
        <ol>
            <li>
                ...
                <span><asp:DropDownList CssClass="field" width="160" ID="ddlDate" runat="server" aria-label="Date" /></span>
            </li>
            <li>
                <label for="<%=ddlEntryType.ClientID%>">Entry Type:</label>
                <span><asp:DropDownList CssClass="field" width="160" ID="ddlEntryType" runat="server" aria-label="Entry type" DataTextField="LeaveType" DataValueField="EntryTypeID" /></span>
            </li>
            <li>
                <label for="<%=txtHours.ClientID%>">Duration:</label>
                <span><asp:TextBox ID="txtHours" Width="40" MaxLength="5" CssClass="Form_Field" aria-label="Duration" runat="server" /></span>
            </li>
            <li>
                <span class="update">
...
<div class="remarks">
    ...
    <asp:Button ID="btnAddRemark" CssClass="button" Text="Add Remark" runat="server" Visible='false' />
        ...
        <label for="<%=txtRemark.ClientID%>">Remark Text:</label>
...
<div class="ts_actions">
    ...
    <asp:Button ID="btnSubmitTimesheet" CssClass="button_important" Text="Submit Timesheet" runat="server" OnClientClick="return confirm('Are you sure you want to submit this timesheet to your supervisor for approval?');" />
    <asp:Button ID="btnDeleteTimesheet" CssClass="button" Text="Delete Timesheet" runat="server" OnClientClick="return confirm('Are you sure you want DELETE this timesheet?');" />
    </asp:Panel>
    <!--*********************************************************************************************-->
